...
function problemB() {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * B. loggea el poema one stanza dos y tres, en cualquier orden
   *    (ignora errores)
   *
   */
...
function problemC() {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * C. lee & loggea el poema one stanza dos y *DESPUES* lee & loggea
...
function problemD() {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * D. loggea el poema one stanza cuatro o un error si llega a ocurrir
   *
   */
...
function problemE() {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * E. Lee y loggea el poema one stanza tres y *DESPUES* lee y loggea la
...
function problemF() {
  /* * * * * * * * * * * * * * * * * * * * * * * * * * * *
   *
   * F. Lee & loggea el poema one stanza tres y *DESPUES* lee y loguea la
